...
function buildPayload(entry: CulturalMomentEntry, params: { year: number; countryQid: string; lang: "fr" | "en"; slot: number }): CulturalScenePayload {
  const matchedYear = entry.year;
  return {
    schema_version: "1.0",
